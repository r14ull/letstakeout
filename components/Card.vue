<template>
	...
	>
		<div v-if="$slots.header" class="card-header" :class="headerClasses" :style="{ backgroundColor: brandColor }">
...
export default {
	...
	data() {
		return {
			brandColor: this.$store.state.restaurant.detail.brand.color
				? this.$store.state.restaurant.detail.brand.color
				: 'brown'
		};
	}
};
